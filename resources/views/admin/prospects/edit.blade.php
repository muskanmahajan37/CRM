        ...
        <div class="col-md-4 offset-md-0 col-sm-8 offset-sm-2">
            ...
            <div class="card mt-3 bg-light" >
                <div class="card-body">
                    ...
                    {{-- @else --}}
                        <img src="/images/man.png" style="max-width: 100%" alt="">
                    {{-- @endif --}}
                    <hr>
                    <button class="btn btn-outline-success btn-sm btn-block" data-toggle="modal" data-target="#updateProfileImageModal">New Profile Image</button>
                    {{-- @if ($prospect->profile_image) --}}
            ...
            <div class="card mt-3">
                <div class="card-body " >
                    ...
                    {{-- <form action="{{ route('admin.prospects.update', $prospect->id) }}" method="POST" enctype="multipart/form-data"> --}}
                        ...
                        <button class="btn bg-success text-white float-right">Update Prospect</button>
                    {{-- </form> --}}
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            {{-- <form action="{{ route('admin.prospects.update.profile-image', $prospect->id) }}" method="POST" enctype="multipart/form-data"> --}}
                ...
                <button class="btn btn-success float-right">Update Profile Image</button>
            </form>
        </div>
      </div>
    </div>
